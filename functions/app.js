...
function addDataInDb(client, done) {
    ...
    console.log(dataosm.length);



    for (let j = 0; j < dataosm.length; j++) {
        ...
        let batiment = {
            ...
            idUser: 1000,
            rue: rue ?? "UNDEFINED",
            image: image ?? "https://service.geo.sm/var/www/notfound.jpg",
        ...
        client.query(query, (err, result) => {
            ...
            try {
                ...
                let etablissement = {
                    ...
                    cover: image ?? "https://service.geo.sm/var/www/notfound.jpg",
                    createdAt: new Date().toISOString().
                        replace(/T/, ' ').
                        replace(/\..+/, ''),
                    updatedAt: new Date().toISOString().
                ...
                let query0 = `INSERT INTO etablissements ("idBatiment", nom, "codePostal", "siteInternet", "idCommercial", "idUser", etage, services, phone, whatsapp1, "osmId",created_at,updated_at,cover) VALUES ('${etablissement.idBatiment}', '${etablissement.nom}', '${etablissement.codePostal}', '${etablissement.siteInternet}', '${etablissement.idCommercial}', '${etablissement.idUser}', '${etablissement.etage}', '${etablissement.services}', '${etablissement.phone}', '${etablissement.whatsapp1}', '${etablissement.osmId}','${etablissement.createdAt}','${etablissement.updatedAt}','${etablissement.cover}' ) RETURNING *`;
                client.query(query0, (err, result) => {


                    let query1 = `INSERT INTO sous_categories_etablissements ("idEtablissement", "idSousCategorie") VALUES ('${result.rows[0].id}', '${souscategorie}')`;
